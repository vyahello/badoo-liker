...
class Wait:
    ...
    def __init__(
        self, browser: Browser, timeout: int = 30, poll_frequency: float = 0.5
    ) -> None:
        """Initialize object.
        ...
        Attributes:
            ...
            poll_frequency: define how often driver should ask for the wait.
        """
        self._browser: Browser = browser
        self._timeout: int = timeout
        self._wait: WebDriverWait = WebDriverWait(
            self._browser, self._timeout, poll_frequency
        )
    ...
    def for_url(self, url_matcher: str) -> None:
        ...
        self._wait.until(
            ...
            message=(
                ...
                f"'{url_matcher}' but it doesn't. "
                f"Timeout {self._timeout} second(s)."
            ),
        )
    ...
    def for_element_to_disappear(self, locator: Tuple[str, str]) -> None:
        ...
        self._wait.until(
            ...
            message=f"Expected element '{locator}' to disappear "
    ...
    def for_element_to_be_visible(self, locator: Tuple[str, str]) -> None:
        ...
        self._wait.until(
            ...
            message=f"Expected element '{locator}' to be visible "
                    f"within {self._timeout} second(s) but it didn't.",
        )
    ...
    def for_element_to_be_clickable(self, locator: Tuple[str, str]) -> None:
        ...
        self._wait.until(
            ...
            message=f"Expected element '{locator}' to be clickable "
                    f"within {self._timeout} second(s) but it didn't.",
        )
